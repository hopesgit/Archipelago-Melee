...
from .MeleeInterface import InventoryItemData

if TYPE_CHECKING:
    from .MeleeClient import MeleeContext
...
def give_item_if_not_owned(
    ctx: "MeleeContext", item_data: InventoryItemData, network_item: NetworkItem
):
...
def disable_item_if_owned(ctx: "MeleeContext", item_data: InventoryItemData):
