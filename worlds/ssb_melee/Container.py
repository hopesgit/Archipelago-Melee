...
from .MeleeInterface import GAMES, HUD_MESSAGE_DURATION, calculate_item_offset
if TYPE_CHECKING:
    import ppc_asm
    from ppc_asm.assembler.ppc import GeneralRegister


class MeleeContainer(APContainer):
    ...
    def __init__(self, config_json: str, options_json: str, outfile_name: str, output_directory: str,
        ...
        container_path = os.path.join(output_directory, outfile_name + ".apssbm")
